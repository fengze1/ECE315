...
/*************************** Enter your code here ****************************/
    ...
    status = XGpio_Initialize(&SDT, SSD_DEVICE_ID );
    if (status != XST_SUCCESS){
        xil_printf("Initialization Incomplete, System Not Ready!\n");
        return XST_FAILURE;
    }
    XGpio_GetDataDirection(&SDT, 1, 0x00);
/*****************************************************************************/
...
/*************************** Enter your code here ****************************/
		...
		*/
        ...
        XGpio_DiscreteWrite(&SDT, 1, ssd_value);
        vTaskDelay(xDelay);
